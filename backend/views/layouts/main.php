...
<!--                </div>-->
                <div class="sidebar-brand-text mx-3">Winkel.uz<sup>2</sup></div>
            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a  data-method="post" class="dropdown-item" href="<?php echo \yii\helpers\Url::to(['site/logout']) ?>" data-toggle="modal" data-target="#logoutModal">
